...
static NSString *UIKitLocalizedString
    (NSString *string)
{
...
static NSArray *EditableTextInputsInView
    (UIView *view)
{
...
- (id) initWithResponders:(NSArray *)responders
{
    ...
    self.frame = _toolbar.frame = (CGRect) {
        CGPointZero, [_toolbar sizeThatFits:CGSizeZero]
    };
